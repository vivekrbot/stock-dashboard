  ...
  async getStockQuote(symbol) {
    ...
    try {
      ...
      const result = {
        ...
        open: parseFloat(stockData.priceopen) || 0,
        high: parseFloat(stockData.pricehigh) || 0,
        low: parseFloat(stockData.pricelow) || 0,
        volume: parseInt(stockData.VOL) || 0,
        '52WeekHigh': parseFloat(stockData.HP52) || 0,
        '52WeekLow': parseFloat(stockData.LP52) || 0,
